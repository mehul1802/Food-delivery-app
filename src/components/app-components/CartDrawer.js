...
class CartDrawer extends Component {
  ...
  handleProductSelect = (cartItem) => {
    ...
    this.props.history.push({
      pathname: '',
      search: "?" + new URLSearchParams({ uid: uid }).toString()
    })
  }
      ...
      <React.Fragment>
                  ...
                  return (
                    <div className="cart-item px-3 py-2" key={cartItem.product_id}>
                      <div className="item-info m-0 row">
                        ...
                        <div className="col-7 p-0" onClick={() => this.handleProductSelect(cartItem)}>
        ...
        {this.state.menuItemOptionsModal &&
          <MenuItemOptionsDialog
            ...
            handleMenuItemOptionsDialog={this.colseMenuItemOptionsDialog}
